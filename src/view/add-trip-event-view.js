...
function getSectionDestination (destination) {
  if (destination) {
    return `
...
function createAddEventTemplate(offersAll,emptyDestination,defaultType) {
  return (`
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers">
          ...
          <div class="event__available-offers">
            ${getOffersByType(offersAll,defaultType)}

          </div>
        </section>
        ${getSectionDestination(emptyDestination)}
      </section>
    </form>
  </li>
`);
